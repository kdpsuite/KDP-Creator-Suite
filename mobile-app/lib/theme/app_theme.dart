...
class AppTheme {
  ...
  static const Color primaryLight =
      Color(0xFF2C3E50); // Deep charcoal for primary actions and headers
  static const Color primaryVariantLight =
      Color(0xFF34495E); // Supporting navigation elements and secondary text
  static const Color secondaryLight = Color(
      0xFF3498DB); // Strategic highlights for conversion progress and active states
  static const Color accentLight =
      Color(0xFF3498DB); // Same as secondary for consistency
  static const Color successLight =
      Color(0xFF27AE60); // Completion indicators and positive feedback
  static const Color warningLight = Color(
      0xFFF39C12); // Processing states and attention-required notifications
  static const Color errorLight = Color(
      0xFFE74C3C); // Clear error communication without aggressive intensity
  static const Color backgroundLight =
      Color(0xFFFAFBFC); // Primary surface color that reduces eye strain
  static const Color surfaceLight =
      Color(0xFFFFFFFF); // Card and modal backgrounds
  static const Color textPrimaryLight =
      Color(0xFF2C3E50); // High contrast reading text
  static const Color textSecondaryLight =
      Color(0xFF7F8C8D); // Supporting information and metadata display
  static const Color borderLight =
      Color(0xFFE1E8ED); // Minimal borders for content separation
  ...
  // Shadow colors with subtle elevation system (2dp, 4dp, 8dp)
