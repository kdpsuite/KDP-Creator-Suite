    ...
    def decorator(f):
        ...
        def decorated_function(*args, **kwargs):
            ...
            try:
                ...
                return error_response("Invalid JSON", code=400, details={"error": str(e)})
            ...
            if schema:
                try:
                    ...
                    return error_response("Validation failed", code=400, details=e.messages)
    ...
    def decorator(f):
        ...
        def decorated_function(*args, **kwargs):
            ...
            if "file" not in request.files:
                return error_response("No file provided", code=400, details={"field": "file"})

            file = request.files["file"]

            # Check if file is empty
            if file.filename == "":
                return error_response("File name is empty", code=400, details={"field": "file"})
