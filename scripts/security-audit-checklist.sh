...
echo "  [ ] ./scripts/support-ticket-triage.sh   # weekly during launch"
echo "  [ ] ./scripts/conversion-funnel-review.sh"
echo "  [ ] ./scripts/supabase-redirect-allowlist-check.sh"
echo "  [ ] Backend CI: bandit -lll + flake8 F-rules + black/isort"
