...
- Name: critical-flows.spec.js >> KDP Creator Suite - Critical Flows >> Landing Page >> should have login button or link
- Location: tests/e2e/critical-flows.spec.js:47:5

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://unlovedproductions.com/
Call log:
  - navigating to "https://unlovedproductions.com/", waiting until "networkidle"
