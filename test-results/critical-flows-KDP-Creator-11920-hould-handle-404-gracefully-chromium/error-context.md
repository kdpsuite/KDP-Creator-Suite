...
```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://unlovedproductions.com/nonexistent-page
Call log:
  - navigating to "https://unlovedproductions.com/nonexistent-page", waiting until "networkidle"
