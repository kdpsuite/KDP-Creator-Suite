...
- Name: critical-flows.spec.js >> KDP Creator Suite - Critical Flows >> API Health >> should have working root endpoint
- Location: tests/e2e/critical-flows.spec.js:200:5
...
Call log:
  - → GET https://unlovedproductions.com/api
