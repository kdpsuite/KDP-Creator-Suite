...
- Name: critical-flows.spec.js >> KDP Creator Suite - Critical Flows >> Login Flow >> should reject invalid credentials
- Location: tests/e2e/critical-flows.spec.js:84:5
...
```ts
  ...
  18  |       const response = await page.goto('/', { waitUntil: 'networkidle' });
  19  |       
