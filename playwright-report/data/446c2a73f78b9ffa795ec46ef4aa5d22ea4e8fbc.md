...
```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://unlovedproductions.com/login
Call log:
  - navigating to "https://unlovedproductions.com/login", waiting until "networkidle"
...
```ts
  ...
  59  |       await page.goto('/login', { waitUntil: 'networkidle' });
  60  |       
...
> 131 |       await page.goto('/login', { waitUntil: 'networkidle' });
      |                  ^ Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://unlovedproductions.com/login
  132 |       
  ...
  184 |       
  185 |       const isLoggedOut = page.url().includes('/login') || page.url() === '/';
  ...
  192 |       const response = await page.request.get('/api/health');
  193 |       
  ...
  201 |       const response = await page.request.get('/api');
  202 |       
