...
- Name: critical-flows.spec.js >> KDP Creator Suite - Critical Flows >> API Health >> should have working health endpoint
- Location: tests/e2e/critical-flows.spec.js:191:5

# Error details

```
Error: apiRequestContext.get: getaddrinfo ENOTFOUND unlovedproductions.com
Call log:
  - → GET https://unlovedproductions.com/api/health
